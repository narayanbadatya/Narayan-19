            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Link
                    href="narayanbadatya129@gmail.com"
                    className="font-medium hover:underline"
                  >
                    narayanbadatya129@gmail.com
                  </Link>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">odisha, India</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Link
                    href="https://www.linkedin.com/in/narayanbadatya"
                    target="_blank"
                    className="font-medium hover:underline"
                  >
                    linkedin.com/in/narayanbadatya
                  </Link>
                </div>
              </div>
            </div>
